...
// Data Types, Conditional, Functions


// 16. Create a function colorMessage() that takes 2 string arguments, favoriteColor and shirtColor.
...
console.log(colorMessage('red', 'green'));    // That is a nice color.
console.log(colorMessage('yellow', 'yellow')); // The shirt is your favorite color!

// 17. Create a function isEven() that takes a number as its only parameter. 
...
// 18. Create a function numberDigits() that takes a single parameter, x.

// If x is between 0 and 9, return the string 'One digit: N', where N is the value of x. 
// For example, numberDigits(5) would return:
// 'One digit: 5'

// If x is between 10 and 99, return the string 'Two digits: N', where N is the value of x. 
// For example, numberDigits(12) would output:
// 'Two digits: 12'

// For any other value of x, including negative numbers, return the string 'The number is: N', where N is the value of x. 
